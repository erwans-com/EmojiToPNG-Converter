  ...
  if (!record) {
    return (
        <div className="p-12 text-center text-[#9B9A97]">
             {data.length === 0 ? "Loading..." : "Emoji not found."}
        </div>
    );
  }
    ...
    <div className="w-full pb-24 animate-in fade-in duration-300">
      ...
      <div className="max-w-[900px] mx-auto px-4 md:px-24 relative -mt-12 md:-mt-16">
        ...
        <div 
            ...
            className="text-7xl md:text-8xl mb-4 select-none cursor-pointer filter drop-shadow-sm hover:scale-105 transition-transform origin-bottom-left w-fit relative group"
            title="Click to copy"
        >
            {record.emoji}
        ...
        <div className="space-y-1 mb-12">
            <div className="flex items-center h-8 group">
                <div className="w-32 md:w-40 flex items-center gap-2 text-[#787774] text-sm">
                    <ImageIcon size={14} />
                    <span>Type</span>
                </div>
        ...
        <div className="space-y-12">
             ...
             <section>
                ...
                <div className="pl-4 border-l-2 border-[#E16D46] bg-[#F7F7F5] py-4 rounded-r pr-4">
